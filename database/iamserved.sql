...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2021 at 07:49 AM
...
CREATE TABLE `list` (
  ...
  `list_pic` varchar(30) NOT NULL,
  `list_st` tinyint(4) NOT NULL DEFAULT 0,
  `list_p1` float NOT NULL DEFAULT 0,
  `list_p2` float NOT NULL DEFAULT 0,
  `list_p3` float NOT NULL DEFAULT 0,
  `list_p4` float NOT NULL DEFAULT 0
...
INSERT INTO `list` (`list_id`, `list_name`, `type_id`, `list_desc`, `list_pic`, `list_st`, `list_p1`, `list_p2`, `list_p3`, `list_p4`) VALUES
(18, 'แมลงปอ-อบ', 5, 'อบน้ำผึ้ง', '000000018list.jpg', 0, 15.5, 0, 0, 0),
(44, 'ทุเรียนทอด', 18, 'ทอดกรอบๆ โรยเกลือ', '000000044list.jpg', 0, 45, 50, 60, 0),
(45, 'ทับทิมอบแห้ง', 4, 'อบแห้งราดน้ำผึ้ง หอม หวาน อร่อย มากๆ', '000000045list.jpg', 0, 35, 45, 0, 0),
(46, 'สะตอผัดเผ็ด', 15, 'ผัดเผ็ดรสดั่งเดิม ใส่เมล็ดพริกไทยสด เคียงเครื่องด้วยกุนเชียง หอม หวาน อร่อย', '000000046list.jpg', 0, 50, 60, 80, 0),
(47, 'มะละกอเชื่อม', 4, 'ราดน้ำเชื่อม และกะทิ หวาน เค็ม มัน เด็กชื่นชอบ', '000000047list.jpg', 0, 25, 30, 40, 0),
(48, 'มังกรราเม็ง', 31, 'ใส่เส้นราเม็ง เหลือง หอม อร่อย พร้อมน้ำซุปซดร้อนๆ รื่นคอ', '000000048list.jpg', 0, 50, 60, 80, 0),
(49, 'ไก่ย่าง', 12, 'อร่อยมากกกกก', '000000049list.jpg', 0, 50, 60, 70, 80);
...
CREATE TABLE `shops` (
  ...
  `shop_desc` varchar(250) NOT NULL,
  `shop_main_pic` varchar(30) NOT NULL,
  `shop_add` varchar(150) NOT NULL,
  `shop_province` int(5) NOT NULL,
  `shop_amphure` int(5) NOT NULL,
  `shop_district` int(6) NOT NULL,
  `shop_zip` int(11) NOT NULL,
  `shop_his` varchar(600) NOT NULL,
  `shop_his_pic` varchar(30) NOT NULL,
  `shop_tel` varchar(15) NOT NULL,
  `shop_line` varchar(100) NOT NULL,
  `shop_facebook` varchar(100) NOT NULL,
...
INSERT INTO `shops` (`shop_id`, `shop_name`, `shop_desc`, `shop_main_pic`, `shop_add`, `shop_province`, `shop_amphure`, `shop_district`, `shop_zip`, `shop_his`, `shop_his_pic`, `shop_tel`, `shop_line`, `shop_facebook`, `user_id`) VALUES
(39, 'ร้านค้ามีความสุขมาก', 'อาหารตามสั่งอร่อยมาก และเครื่องดื่ม รับจัดส่งนอกสถานที่', '000000039main.jpg', '191 หมู่1 ถนนมิตรภาพ', 28, 393, 400101, 40000, 'ร้านค้าดั่งเดิมในสมัยอยุธยา ต้นกำเนิดอาหารไทยอันเรื่องชื่อ ความอร่อยเป็นเลิศ ชนะการประกวดมาแล้วทั่วประเทศไทย ดารานักร้องเข้ามาอุดหนุนกันต่อเนื่อง สามารถถ่ายภาพมุมสวยๆ ที่ทางร้านจัดไว้ให้ได้', '000000039his.jpg', '0819545765', 'iam@serm', 'surasak iamserm', 9),
(47, 'หน้าด้านกาแฟสด', 'sohkdfasdfadsfadsfdsafsadfdsa', '000000047main.jpg', '343', 50, 725, 630604, 63110, 'sdfasdfadsfasdf', '000000047his.jpg', '11111111', '234', 'sdf', 10);
...
CREATE TABLE `type` (
  ...
  `type_st` tinyint(4) NOT NULL DEFAULT 0,
  `shop_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `type` (`type_id`, `type_name`, `type_st`, `shop_id`) VALUES
(4, 'ออร์เดิฟ', 0, 39),
(5, 'ต้ม/นึ่ง/ตุ๋น', 0, 39),
(9, 'เครื่องดื่ม', 0, 39),
(11, 'ข้าวราดแกง', 0, 47),
(12, 'ของหวาน', 0, 47),
(15, 'ผัด', 1, 39),
(18, 'ทอด', 1, 39),
(21, 'อาหารจานเดียว', 0, 39),
(31, 'ก๋วยเตี๋ยว', 0, 39),
(32, 'จานพิเศษ', 0, 39);
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `tel`, `type`, `email`, `password`, `created`, `modified`) VALUES
(5, 'surasak', 'iamserm', '', 0, 'surasak@aaa.com', '$2y$10$7ehiNm27eJUxIbSLscriAOYU26xM9bgM5W9Ub2un9.gU99N.jqvX2', '2021-04-26 15:37:58', '2021-05-07 06:48:38'),
(8, 'สุรศักดิ์', 'เอี่ยมเสริม', '', 0, 'surasak21@aaa.com', '$2y$10$IQ.R6d9jzBUFZYXsFpFFGODwGVAGcuv0l8FIgDvuLV40AUVg72K3.', '2021-05-05 15:03:15', '2021-05-05 09:42:44'),
(9, 'surasak', 'iasmerm', '', 2, 'surasak-i@hotmail.com', '$2y$10$EDzw839U6HPgZAP8UxnI6.v8zcDB2ApDMkF2z337r8iku6oasDdD2', '2021-05-10 16:13:30', '2021-06-04 09:17:20'),
(10, 'สุรศักดิ์', 'เอี่ยมเสริม', '', 2, 'surasak_iamserm@yahoo.com', '$2y$10$TA7hvCvg3Ne2Y/20NRkwxeqCZIBQ5qTNrvn4miXa4OVn9DhzyEaR6', '2021-05-14 13:41:17', '2021-06-05 10:02:03'),
(11, 'aaaa', 'bbbb', '', 0, 'jakrapat.iam@gmail.com', '$2y$10$ze7CQbbsJ8jGb.QDy6K4oupkDTS/dMQCevbkRRpUStvzEcy9/Keee', '2021-05-15 13:53:17', '2021-05-15 06:53:17');
...
--
ALTER TABLE `shops`
  MODIFY `shop_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `type`
--
ALTER TABLE `type`
  MODIFY `type_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
